...
public interface IAppointmentRepository : IRepository<Appointment>
{
    ...
    Task<IReadOnlyList<Appointment>> GetFilteredAsync(int? employeeId, int? userId, AppointmentStatus? status, DateTime? start, DateTime? end, string? search = null, CancellationToken cancellationToken = default);
