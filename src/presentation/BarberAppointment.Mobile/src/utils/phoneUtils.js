...
export const isValidTurkishPhone = (value) => {
  ...
  // Baştaki 0'ı temizle (opsiyonel)
  if (digits.startsWith('0')) {
    digits = digits.slice(1);
  }

  // Türkiye cep telefonu: 10 hane ve 5 ile başlamalı (5XXXXXXXXX)
  const turkishMobileRegex = /^5[0-9]{9}$/;
  return turkishMobileRegex.test(digits);
};

/**
 * Backend'e veya SMS servisine gönderilmek üzere standart 11 haneli (05XXXXXXXXX)
 * formatta normalleştirir.
 */
